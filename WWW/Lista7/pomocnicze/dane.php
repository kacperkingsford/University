...
<body>
    ...
    <form name="dane" action="dane.php" method="get">
        <table align="center" cellpadding="4" cellspacing="2" border="0" bgcolor="#FF9900">
            ...
            <tr>
                ...
                <td><input name="nazwisko" type="text" size="20" maxlength="40" value=""></td>
            </tr>
            <tr>
                <th align="left">Adres:</th>
                <td><input name="adres[]" type="text" size="6" maxlength="6" value="">
                    <input name="adres[]" type="text" size="10" maxlength="20" value="">
                    <input name="adres[]" type="text" size="20" maxlength="30" value=""></td>
            </tr>
            <tr>
                <th align="left">PESEL:</th>
                <td><input name="pesel" type="text" size="11" maxlength="11" value=""></td>
            </tr>
            <tr>
                <th align="left">Płeć:</th>
                <td><input name="plec" type="radio" value="m"> Mężczyzna&nbsp;&nbsp;
                    <input name="plec" type="radio" value="k"> Kobieta</td>
            </tr>
            <tr>
                <th align="left">Ulubione kolory:</th>
                <td>
    ...
    ?>
        <table cellpadding="4" cellspacing="2" border="1" align="center">
            <tr>
                <th>Imi�:</th>
                <td><?php echo $_GET["imie"]; ?></td>
            </tr>
            <tr>
                <th>Nazwisko:</th>
                <td><?php echo $_GET["nazwisko"]; ?></td>
            </tr>
            <tr>
                <th>Adres:</th>
                <td><?php echo join($_GET["adres"], ", "); ?></td>
            </tr>
            <tr>
                <th>PESEL:</th>
                <td><?php echo $_GET["pesel"]; ?></td>
            </tr>
            <tr>
                <th>P�e�</th>
                <td><?php echo $_GET["plec"]; ?></td>
            </tr>
            <tr>
                <th>Kolorki:</th>
                <td><?php echo join((isset($_GET["kolory"]) ? $_GET["kolory"] : array()), ", "); ?></td>
            </tr>
        </table>
    <?php
    endif;
