...
(provide inc tagged-list? make-elem elem-priority elem-val leaf? hnode? make-hnode hnode-elem hnode-left hnode-right hnode-rank hord? heap? rank empty-heap heap-insert heap-merge heap-min heap-pop heap-empty?)
...
;Współparcowałem z Mateuszem Szwelengreberem i Dominikiem Budzkim
